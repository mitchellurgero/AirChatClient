...
*/
$http_bind = "http://ds4.urgero.org:5280/http-bind"; //URL of the HTTP-BIND service of the XMPP Server
$fqdn_xmpp = "ds4.urgero.org"; //the Fully Qualified Domain Name of the server (EX: example.com) (This MUST be the domain the user authenticates against.) (If the server is xmpp.example.com, but the domain of authentication is example.com, put example.com)
$xmpp_port = "5222"; //The port of the XMPP server (Usually 5222)(Or 5223 for Legacy SSL)
$muc_xmpp = "conference.ds4.urgero.org"; //MUC service URL, configured on server, does not usually need to be in DNS.
