...
<html lang="en">
  <head>
    ...
    <title>Chat <?php echo $_GET['usr']; ?></title>
    <!-- Strophe Chat JS -->
	...
	function onConnect(status)
	{
    	if (status == Strophe.Status.CONNECTING) {
			...
			var d = $pres({"from":"<?php echo $_SESSION['username']."@".$fqdn_xmpp; ?>","to":"<?php echo $_GET['usr']; ?>@<?php echo $fqdn_xmpp; ?>"}).c("x",{"xmlns":"http://jabber.org/protocol/muc"});
...
function sendMsg(){
    ...
    var o = {to:"<?php echo $_GET['usr']; ?>@<?php echo $fqdn_xmpp; ?>", type : 'chat'}; 
...
window.onbeforeunload = confirmExit;
  ...
  <body style="background-color:#eee;">
  	<br />
  	<center><h3>Chat: <?php echo $_GET['usr']; ?></h3></center>
  	<br />
  	<br />
